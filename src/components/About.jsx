    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-auto">
        ...
        <p
          ...
          className="text-xl mt-5 ease-in fade-in"
        >
          This is Vishal Yadav and I'm a front-end developer, Computer Science
          Student, also working as a Freelancer. Currently I am working on my
          problem solving skills and Back-end Development.
        </p>
        ...
        >
          ...
          <a href="./Resume-Vishal.pdf" download>
            Download CV
          </a>
        </div>
      </div>
